import { Paragraph, ParagraphChild, Table, TableOfContents, IImageOptions } from "docx";
...
export declare const mdastToDocx: (node: mdast.Root, { output, title, subject, creator, keywords, description, lastModifiedBy, revision, styles, background, }: DocxOptions, images: ImageDataMap) => Promise<any>;
export {};
